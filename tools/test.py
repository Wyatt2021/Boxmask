...
def parse_args():
    ...
    parser.add_argument('--config',default='/home/xd/mm/BoxMask-main/configs/vid/temporal_roi_align/boxMask_selsa_troialign_faster_rcnn_r50_dc5_7e_imagenetvid.py', help='test config file path')
    parser.add_argument('--checkpoint', help='checkpoint file')
    parser.add_argument('--out',default='/home/xd/mm/resultmm/result.pkl', help='output result file')
    parser.add_argument(
        '--work-dir',
