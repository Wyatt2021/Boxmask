...
def parse_args():
    ...
    print("1")
    parser.add_argument('--config',default='/home/xd/mm/BoxMask-main/configs/vid/temporal_roi_align/boxMask_selsa_troialign_faster_rcnn_r50_dc5_7e_imagenetvid.py', help='train config file path')
    print("2")
